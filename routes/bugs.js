...
router.get(
  "/",
  UserController.restrictDev,
  BugController.index,
  BugController.indexView
);
...
router.get(
  "/assigned",
  UserController.restrictDev,
  BugController.assignedToMe,
  BugController.indexView
); //why order matters??

/* filter bugs*/ router.get(
  "/:status",
  UserController.restrictDev,
  BugController.showfilteredBugs,
  BugController.indexView
);
